export default function AboutComp(props)
{
    return(
        <div className="flex w-[90%] ml-6 md:ml-auto mr-auto h-[80%] md:h-[60%] gap-4 flex-col md:flex-row mb-[10%]">
            ...
            <button className="bg-slate-900 text-white text-3xl lg:text-lg pl-4 pr-4 rounded-lg w-fit pt-2 pb-2 text-center content-center hover:bg-slate-700">Read more</button>
            </div>
